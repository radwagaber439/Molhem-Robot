...
class FromTen extends StatefulWidget {
  const FromTen({Key? key}) : super(key: key);

  @override
  State<FromTen> createState() => _FromTenState();
}

class _FromTenState extends State<FromTen> {
...
//
  ...
  void move(){
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Chatgpt(texty: " قيم الاجابه من 10"+lastWords,)),
    );
  }
