  ...
  void _initializeBoard() {
    ...
    for (int i = 0; i < 8; i++) {
      newBoard[1][i] = ChessPiece(
        ...
        isWhite: false,
        imagePath: 'asset/images/pawn.png',
      );
    ...
    newBoard[0][0] = ChessPiece(
        ...
        isWhite: false,
        imagePath: "asset/images/rook.png");
    ...
    newBoard[0][1] = ChessPiece(
        ...
        isWhite: false,
        imagePath: "asset/images/knight.png");
    ...
    newBoard[0][2] = ChessPiece(
        ...
        isWhite: false,
        imagePath: "asset/images/bishop.png");
    ...
    newBoard[0][3] = ChessPiece(
      ...
      isWhite: false,
      imagePath: 'asset/images/queen.png',
    );
    ...
    newBoard[0][4] = ChessPiece(
      ...
      isWhite: false,
      imagePath: 'asset/images/king.png',
    );
...
// add the captured piece to the appropriate list
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        width: SizeApp.screenWidth(context)*.5,
        height: SizeApp.screenHeight(context),
        child: Column(
          children: [
            Expanded(
